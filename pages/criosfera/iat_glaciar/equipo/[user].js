                                    ...
                                    <div className='flex flex-col flex-1 w-full md:max-w-2xl lg:max-w-2xl'>
                                        ...
                                        <div className='footer mt-10 mr-auto'>
                                            <div className='flex flex-wrap gap-2'>
                                                ...
                                                <a href={item.team[parseInt(router.query.user.slice(0, 1))].redes.linkedin} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.team[parseInt(router.query.user.slice(0, 1))].redes.linkedin === null?'hidden':'block'} `}><h1>LinkedIn</h1></a>
                                                <a href={item.team[parseInt(router.query.user.slice(0, 1))].redes.orcid} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.team[parseInt(router.query.user.slice(0, 1))].redes.orcid === null?'hidden':'block'} `}><h1>ORCID</h1></a>
                                                <a href={item.team[parseInt(router.query.user.slice(0, 1))].redes.ctvitae} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.team[parseInt(router.query.user.slice(0, 1))].redes.ctvitae === null?'hidden':'block'} `}><h1>CTI Vitae</h1></a>
                                                <a href={item.team[parseInt(router.query.user.slice(0, 1))].redes.researchgate} target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.team[parseInt(router.query.user.slice(0, 1))].redes.researchgate === null?'hidden':'block'} `}><h1>ResearchGate</h1></a>
                                            </div>
                                        </div>                                
                                    </div>
