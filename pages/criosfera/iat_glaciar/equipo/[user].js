        ...
        <Layout>
            ...
            <main>
                ...
                <div className='usuario'>
                    {
                        listaTeam.map((item)=>{
                            if(item.user === router.query.user){
                                return <Fragment key={item.id}>
                                    <div className='relative w-full h-72 lg:h-96'>
                                        <Image className='cover' layout='fill' src='/fondos/Laguna_pequeña.JPG' alt='Grupo de investigación'/>
                                    ...
                                    <div className='flex flex-col lg:flex-row justify-center lg:justify-between pb-16 px-4 lg:px-16'>
                                        <div onClick={() => router.back()}>
                                            <div className='flex hidden lg:flex h-7 w-20 mt-5 cursor-pointer'>
                                        ...
                                        <div className='flex-1 w-full md:max-w-2xl lg:max-w-2xl -mt-24 mx-auto'>
                                            <div className='relative rounded-full cover border-2 border-white z-20 mx-auto w-40 h-40 lg:w-56 lg:h-56'><Image className='rounded-full' layout='fill' src={`${item.foto}`} alt='Grupo de investigación'/></div>
                                            <div className='mt-3'>
                                            ...
                                            <div className='footer mt-10 mr-auto'>
                                                <div className='flex flex-wrap gap-2'>
                                                    <div className='flex items-center gap-2 bg-gray-200 py-2 px-4 cursor-pointer rounded-md'>
                                                        ...
                                                        <a href={item.contacto.correo}><h1 className='text-color'>{item.contacto.email}</h1></a>
                                                    </div>
                                                    {
                                                        /**
                                                         * <a href={item.redes.linkedin} rel="noopener" target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.redes.linkedin === null?'hidden':'block'} `}><h1>LinkedIn</h1></a>
                                                            <a href={item.redes.orcid} rel="noopener" target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.redes.orcid === null?'hidden':'block'} `}><h1>ORCID</h1></a>
                                                            <a href={item.redes.ctvitae} rel="noopener" target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.redes.ctvitae === null?'hidden':'block'} `}><h1>CTI Vitae</h1></a>
                                                            <a href={item.redes.researchgate} rel="noopener" target='_blank' className={`bg-gray-200 py-2 px-4 rounded-md text-color ${item.redes.researchgate === null?'hidden':'block'} `}><h1>ResearchGate</h1></a>
                                                        */
                                                    }
                                                </div>
                                            </div>                                
                                        </div>
                                        <h1 className='mt-5 font-bold text-color hidden lg:block'>{item.equipo}</h1>
                                    </div>
                                    <Footer />
                                </Fragment>
                            }
